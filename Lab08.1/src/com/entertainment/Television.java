...
public class Television {
    ...
    private Tuner tuner = new Tuner();      // instantiated internally, no exposed(via get/set)
    ...
    public void setBrand(String brand) {
        if (isValidBrand(brand)) {
            ...
            System.out.printf("Invalid brand: %s. Valid brand are %S.\n", brand,Arrays.toString(VALID_BRANDS) );
    ...
    public void setVolume(int volume) {
        if (MIN_VOLUME <= volume && volume <= MAX_VOLUME) {
            ...
            System.out.printf("Invalid volume: %s valid range is %s to %s. \n",
                    getVolume(),MIN_VOLUME,MAX_VOLUME);
